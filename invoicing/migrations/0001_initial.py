# Generated by Django 4.2 on 2024-07-12 18:48
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("fastcode", models.CharField(max_length=10, unique=True)),
                ("description", models.TextField(blank=True, max_length=255)),
                (
                    "unity_of_mesure",
                    models.CharField(
                        choices=[("M", "Mètre(s)"), ("KG", "KG"), ("PC", "Pièce(s)")],
                        max_length=10,
                    ),
                ),
                (
                    "unit_price",
                    models.DecimalField(decimal_places=2, max_digits=10, null=0),
                ),
